...
public class GrammarFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private GrammarGrammarAccess _grammarGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._grammarGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._grammarGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._grammarGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._grammarGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._grammarGrammarAccess.getML_COMMENTRule();
