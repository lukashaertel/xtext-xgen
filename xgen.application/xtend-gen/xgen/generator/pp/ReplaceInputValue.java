...
public class ReplaceInputValue extends TransformAll<Object,Integer,Object> {
  ...
  protected Pair<Integer,Leaf> transformOneLeaf(final Pair<Integer,Leaf> p) {
    boolean _notEquals = (!Objects.equal(p.b.value, "<input value>"));
    if (_notEquals) {
      return p;
    }
    int _plus = ((p.a).intValue() + 1);
    String _plus_1 = ("Input" + p.a);
